/**
 * Advanced Form Integration — "freeagent" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("freeagent").
 */

Vue.component('freeagent', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_freeagent_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_freeagent_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#freeagent-action-template'
});
