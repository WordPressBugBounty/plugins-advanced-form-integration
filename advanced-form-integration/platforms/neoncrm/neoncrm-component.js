Vue.component('neoncrm', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_neoncrm_fields', { task: this.action.task, includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#neoncrm-action-template'
});
