        ...
        <table class="form-table">
            ...
            <tr valign="top" class="alternate" v-if="action.task == 'create_account' || action.task == 'create_donation'">
                ...
                <td>
                    ...
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=advanced-form-integration-settings&tab=neoncrm' ) ); ?>" target="_blank" style="margin-left: 10px; text-decoration: none;"><span class="dashicons dashicons-admin-settings" style="margin-top: 3px;"></span> <?php esc_html_e( 'Manage Accounts', 'advanced-form-integration' ); ?></a>
                </td>
            </tr>
