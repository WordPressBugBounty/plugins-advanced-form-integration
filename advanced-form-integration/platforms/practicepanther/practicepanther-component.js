Vue.component('practicepanther', {
    ...
    mounted: function () {
        ...
        adfoinHelpers.fetchCredentials(this, 'adfoin_get_practicepanther_credentials', { loadingKey: 'credentialLoading', clearOnFail: true });
    ...
    template: '#practicepanther-action-template'
});
