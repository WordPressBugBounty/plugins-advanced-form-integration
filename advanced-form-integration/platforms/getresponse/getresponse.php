...
add_action( 'wp_ajax_adfoin_get_getresponse_credentials', 'adfoin_get_getresponse_credentials', 10, 0 );
/*
...
add_action( 'wp_ajax_adfoin_save_getresponse_credentials', 'adfoin_save_getresponse_credentials', 10, 0 );
/*
...
// Legacy single-account import: surfaces old `adfoin_getresponse_*` options
// as a Legacy Account record when the new credentials store is empty.
add_action( 'plugins_loaded', function() {
    if ( class_exists( 'ADFOIN_Account_Manager' ) ) {
        ADFOIN_Account_Manager::register_legacy_option_importer( 'getresponse', array(
            'apiKey' => 'adfoin_getresponse_api_key',
        ) );
    }
}, 20 );
    ...
    <script type="text/template" id="getresponse-action-template">
        <table class="form-table">
            ...
            <tr valign="top" class="alternate" v-if="action.task == 'subscribe'">
                <td scope="row-title">
                    <label for="tablecell">
                        <?php esc_attr_e( 'GetResponse Account', 'advanced-form-integration' ); ?>
                    </label>
                </td>
                <td>
            ...
            <?php adfoin_pro_feature_notice( 'subscribe', 'GetResponse [PRO]', 'custom fields and tags' ); ?>
        </table>
    </script>
    <?php
}
...
add_action( 'adfoin_getresponse_job_queue', 'adfoin_getresponse_job_queue', 10, 1 );
