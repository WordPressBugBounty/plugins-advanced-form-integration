/**
 * Advanced Form Integration - "kirimemail" action component.
 * Auto-extracted from assets/js/script.js. Loaded on demand by
 * adfoinComponentLoader.loadPlatform("kirimemail").
 */
...
Vue.component('kirimemail', {
    ...
    methods: {
        getLists: function () {
            adfoinHelpers.fetchToFielddata(this, 'adfoin_get_kirimemail_lists', {
                targetKey: 'lists',
