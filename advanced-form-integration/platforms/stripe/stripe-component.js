/**
 * Advanced Form Integration — "stripe" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("stripe").
 */
...
Vue.component('stripe', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_stripe_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_stripe_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#stripe-action-template'
});
