/**
 * Advanced Form Integration — "myob" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("myob").
 */
...
Vue.component('myob', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_myob_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
