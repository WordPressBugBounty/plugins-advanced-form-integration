/**
 * Advanced Form Integration — "recruitee" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("recruitee").
 */

Vue.component('recruitee', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_recruitee_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_recruitee_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#recruitee-action-template'
});
