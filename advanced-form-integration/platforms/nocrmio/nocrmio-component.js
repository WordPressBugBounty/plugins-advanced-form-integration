/**
 * Advanced Form Integration — "nocrmio" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("nocrmio").
 */

Vue.component('nocrmio', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_nocrmio_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_nocrmio_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#nocrmio-action-template'
});
