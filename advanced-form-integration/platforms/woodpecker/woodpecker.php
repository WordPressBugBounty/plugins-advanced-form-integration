...
class ADFOIN_Woodpecker {
    ...
    public function settings_view( $current_tab ) {
        ...
        ADFOIN_Account_Manager::render_settings_view( 'woodpecker', 'Woodpecker.co', $fields, $instructions );
    }
    ...
    public function get_credentials() {
        ...
        ADFOIN_Account_Manager::ajax_get_credentials_list( 'woodpecker' );
    }
        ...
        <script type="text/template" id="woodpecker-action-template">
            <table class="form-table">
                <tr valign="top" v-if="action.task == 'subscribe'">
                    <th scope="row">
                        <?php esc_attr_e( 'Woodpecker Account', 'advanced-form-integration' ); ?>
                    </th>
                    <td>
                ...
                <?php adfoin_pro_feature_notice( 'subscribe', 'Woodpecker.co [PRO]', 'custom fields' ); ?>
     ...
     */
    public function api_request( $endpoint, $method = 'GET', $data = array(), $record = array() ) {
        if( !$this->api_key ) {
