/**
 * Advanced Form Integration — "employmenthero" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("employmenthero").
 */

Vue.component('employmenthero', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_employmenthero_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_employmenthero_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#employmenthero-action-template'
});
