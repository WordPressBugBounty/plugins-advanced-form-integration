/**
 * Advanced Form Integration — "vision6" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("vision6").
 */

Vue.component('vision6', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_vision6_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_vision6_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#vision6-action-template'
});
