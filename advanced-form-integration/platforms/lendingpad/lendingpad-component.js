Vue.component('lendingpad', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_lendingpad_fields', { task: 'create_loan', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#lendingpad-action-template'
});
