/**
 * Advanced Form Integration — "dynamics365fieldservice" action component.
 * Reuses the Dynamics 365 CRM credential list.
 */

Vue.component('dynamics365fieldservice', {
    ...
    methods: {
        getFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_dynamics365fieldservice_fields',
    ...
    template: '#dynamics365fieldservice-action-template'
});
