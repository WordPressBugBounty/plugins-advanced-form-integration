/**
 * Advanced Form Integration — "tawkto" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("tawkto").
 */

Vue.component('tawkto', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_tawkto_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_tawkto_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#tawkto-action-template'
});
