Vue.component('vagaro', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_vagaro_fields', { task: 'create_customer', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#vagaro-action-template'
});
