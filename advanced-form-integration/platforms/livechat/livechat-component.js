/**
 * Advanced Form Integration — "livechat" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("livechat").
 */

Vue.component('livechat', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_livechat_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_livechat_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#livechat-action-template'
});
