...
add_filter( 'adfoin_action_providers', 'adfoin_robly_actions', 10, 1 );
...
add_filter( 'adfoin_settings_tabs', 'adfoin_robly_settings_tab', 10, 1 );
...
add_action( 'adfoin_settings_view', 'adfoin_robly_settings_view', 10, 1 );
...
function adfoin_robly_settings_view( $current_tab ) {
    ...
    ADFOIN_Account_Manager::render_settings_view( 'robly', 'Robly', $fields, $instructions );
}
...
add_action( 'admin_post_adfoin_save_robly_api_key', 'adfoin_save_robly_api_key', 10, 0 );
...
function adfoin_save_robly_api_key() {
    ...
    $api_id  = sanitize_text_field( wp_unslash( $_POST['adfoin_robly_api_id'] ) );
    $api_key = sanitize_text_field( wp_unslash( $_POST['adfoin_robly_api_key'] ) );
...
?>
    <script type="text/template" id="robly-action-template">
        <table class="form-table">
            ...
            <?php adfoin_pro_feature_notice( 'subscribe', 'Robly [PRO]', 'custom fields and tags' ); ?>
...
add_action( 'wp_ajax_adfoin_get_robly_list', 'adfoin_get_robly_list', 10, 0 );
...
add_action( 'adfoin_robly_job_queue', 'adfoin_robly_job_queue', 10, 1 );
