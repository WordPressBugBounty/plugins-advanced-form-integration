Vue.component('aidium', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_aidium_fields', { task: 'create_contact', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#aidium-action-template'
});
