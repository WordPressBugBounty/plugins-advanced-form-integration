...
add_action( 'adfoin_settings_view', 'adfoin_zendesk_settings_view', 10, 1 );
...
add_action( 'wp_ajax_adfoin_save_zendesk_credentials', 'adfoin_save_zendesk_credentials', 10, 0 );
