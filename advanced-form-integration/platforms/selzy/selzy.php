...
add_filter( 'adfoin_action_providers', 'adfoin_selzy_actions', 10, 1 );
...
add_filter( 'adfoin_settings_tabs', 'adfoin_selzy_settings_tab', 10, 1 );
...
add_action( 'adfoin_settings_view', 'adfoin_selzy_settings_view', 10, 1 );
...
function adfoin_selzy_settings_view( $current_tab ) {
    ...
    ADFOIN_Account_Manager::render_settings_view( 'selzy', 'Selzy', $fields, $instructions );
}
...
?>
    <script type="text/template" id="selzy-action-template">
        <table class="form-table">
            ...
            <?php adfoin_pro_feature_notice( 'subscribe', 'Selzy [PRO]', 'custom fields and tags' ); ?>
...
add_action( 'wp_ajax_adfoin_get_selzy_list', 'adfoin_get_selzy_list', 10, 0 );
...
add_action( 'adfoin_selzy_job_queue', 'adfoin_selzy_job_queue', 10, 1 );
