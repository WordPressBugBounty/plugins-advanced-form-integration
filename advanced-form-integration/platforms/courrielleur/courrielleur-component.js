/**
 * Advanced Form Integration - "courrielleur" action component.
 * Auto-extracted from assets/js/script.js. Loaded on demand by
 * adfoinComponentLoader.loadPlatform("courrielleur").
 */
...
Vue.component('courrielleur', {
    ...
    methods: {
        getLists: function () {
            adfoinHelpers.fetchToFielddata(this, 'adfoin_get_courrielleur_lists', {
                targetKey: 'lists',
