/**
 * Advanced Form Integration — "vismaeaccounting" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("vismaeaccounting").
 */

Vue.component('vismaeaccounting', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_vismaeaccounting_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_vismaeaccounting_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#vismaeaccounting-action-template'
});
