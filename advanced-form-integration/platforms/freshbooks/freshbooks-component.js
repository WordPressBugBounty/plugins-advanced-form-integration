/**
 * Advanced Form Integration — "freshbooks" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("freshbooks").
 */

Vue.component('freshbooks', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_freshbooks_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_freshbooks_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#freshbooks-action-template'
});
