Vue.component('sierrainteractive', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_sierrainteractive_fields', { task: 'create_lead', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#sierrainteractive-action-template'
});
