/**
 * Advanced Form Integration — "economic" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("economic").
 */

Vue.component('economic', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_economic_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_economic_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#economic-action-template'
});
