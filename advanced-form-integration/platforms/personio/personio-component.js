/**
 * Advanced Form Integration — "personio" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("personio").
 */

Vue.component('personio', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_personio_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_personio_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#personio-action-template'
});
