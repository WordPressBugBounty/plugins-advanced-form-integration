Vue.component('hawksoft', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_hawksoft_fields', { task: 'create_client', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#hawksoft-action-template'
});
