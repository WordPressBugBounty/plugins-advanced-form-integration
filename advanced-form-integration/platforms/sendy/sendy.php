...
add_action( 'admin_post_adfoin_save_sendy_api_key', 'adfoin_save_sendy_api_key', 10, 0 );
...
function adfoin_save_sendy_api_key() {
    ...
    $api_key = sanitize_text_field( wp_unslash( $_POST["adfoin_sendy_api_key"] ) );
    $url     = sanitize_text_field( wp_unslash( $_POST["adfoin_sendy_url"] ) );
...
add_action( 'adfoin_add_js_fields', 'adfoin_sendy_js_fields', 10, 1 );
