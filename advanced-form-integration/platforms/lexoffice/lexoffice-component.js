/**
 * Advanced Form Integration — "lexoffice" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("lexoffice").
 */

Vue.component('lexoffice', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_lexoffice_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_lexoffice_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#lexoffice-action-template'
});
