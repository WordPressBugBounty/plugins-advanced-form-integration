/**
 * Advanced Form Integration - "realgeeks" action component.
 */
Vue.component('realgeeks', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_realgeeks_fields', {
    ...
    template: '#realgeeks-action-template'
});
