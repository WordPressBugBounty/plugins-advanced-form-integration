...
function adfoin_moosend_settings_view( $current_tab ) {
    ...
    ADFOIN_Account_Manager::render_settings_view( 'moosend', 'Moosend', $fields, $instructions );
}
        ...
        <table class="form-table">
            <tr valign="top" v-if="action.task == 'subscribe'">
                ...
                <td>
                    ...
                    <a href="<?php echo admin_url( 'admin.php?page=advanced-form-integration-settings&tab=moosend' ); ?>" 
                       target="_blank" 
            ...
            <?php adfoin_pro_feature_notice( 'subscribe', 'Moosend [PRO]', 'custom fields' ); ?>
...
function adfoin_get_moosend_list() {
    ...
    $data = adfoin_moosend_request( 'lists.json?PageSize=1000', 'GET', array(), array(), $cred_id );
...
*/
function adfoin_moosend_request( $endpoint, $method = 'GET', $data = array(), $record = array(), $cred_id = '' ) {
    ...
    $url = add_query_arg( array( 'apikey' => $api_token ), $url );
...
add_action( 'adfoin_moosend_job_queue', 'adfoin_moosend_job_queue', 10, 1 );
