/**
 * Advanced Form Integration — "crisp" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("crisp").
 */
...
Vue.component('crisp', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_crisp_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_crisp_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#crisp-action-template'
});
