/**
 * Advanced Form Integration — "workable" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("workable").
 */

Vue.component('workable', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_workable_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_workable_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#workable-action-template'
});
