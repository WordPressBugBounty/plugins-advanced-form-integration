/**
 * Advanced Form Integration — "eventbrite" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("eventbrite").
 */
...
Vue.component('eventbrite', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_eventbrite_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_eventbrite_fields',
                _nonce: adfoin.nonce
            }, function (response) {
