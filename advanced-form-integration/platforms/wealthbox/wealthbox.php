...
add_filter('adfoin_action_providers', 'adfoin_wealthbox_actions', 10, 1);
...
add_filter('adfoin_settings_tabs', 'adfoin_wealthbox_settings_tab', 10, 1);
...
function adfoin_wealthbox_settings_view($current_tab)
{
    ...
    ADFOIN_Account_Manager::render_settings_view( 'wealthbox', 'Wealthbox', $fields, $instructions );
}
        ...
        <table class="form-table">
            <tr valign="top" v-if="action.task == 'add_contact'">
                ...
                <td>
                    ...
                    <a href="<?php echo admin_url( 'admin.php?page=advanced-form-integration-settings&tab=wealthbox' ); ?>" 
                       target="_blank" 
            ...
            <?php adfoin_pro_feature_notice( 'add_contact', 'Wealthbox [PRO]', 'tags & custom fields' ); ?>
...
add_action('wp_ajax_adfoin_get_wealthbox_owner_list', 'adfoin_get_wealthbox_owner_list', 10, 0);
 ...
 */
function adfoin_wealthbox_request($endpoint, $method = 'GET', $data = array(), $record = array(), $cred_id = '')
{
...
add_action( 'adfoin_wealthbox_job_queue', 'adfoin_wealthbox_job_queue', 10, 1 );
...
function adfoin_wealthbox_send_data($record, $posted_data)
{
    ...
    if ($task == 'add_contact') {
        ...
        $return = adfoin_wealthbox_request('contacts', 'POST', $request_data, $record, $cred_id);
    }
