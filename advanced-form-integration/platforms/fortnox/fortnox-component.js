/**
 * Advanced Form Integration - "fortnox" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("fortnox").
 */

Vue.component('fortnox', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_fortnox_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_fortnox_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#fortnox-action-template'
});
