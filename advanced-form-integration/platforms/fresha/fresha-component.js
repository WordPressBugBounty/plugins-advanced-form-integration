Vue.component('fresha', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_fresha_fields', { task: 'create_client', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#fresha-action-template'
});
