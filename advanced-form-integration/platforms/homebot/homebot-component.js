Vue.component('homebot', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_homebot_fields', { task: 'create_client', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#homebot-action-template'
});
