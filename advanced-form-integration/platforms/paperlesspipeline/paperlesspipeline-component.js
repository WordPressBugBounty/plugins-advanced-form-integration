Vue.component('paperlesspipeline', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_paperlesspipeline_fields', { task: 'create_transaction', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#paperlesspipeline-action-template'
});
