/**
 * Advanced Form Integration — "shopify" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("shopify").
 */
...
Vue.component('shopify', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_shopify_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_shopify_fields',
                _nonce: adfoin.nonce
            }, function (response) {
