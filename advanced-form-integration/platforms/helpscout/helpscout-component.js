/**
 * Advanced Form Integration — "helpscout" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("helpscout").
 *
 * Fields differ per task (create_conversation vs create_customer) so the
...
Vue.component('helpscout', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_helpscout_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            if (!this.action || (this.action.task !== 'create_conversation' && this.action.task !== 'create_customer')) {
                this.fields = [];
                return;
            }
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_helpscout_fields',
                task: task,
                _nonce: adfoin.nonce
            }, function (response) {
