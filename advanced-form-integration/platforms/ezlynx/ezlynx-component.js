Vue.component('ezlynx', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_ezlynx_fields', { task: 'create_applicant', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#ezlynx-action-template'
});
