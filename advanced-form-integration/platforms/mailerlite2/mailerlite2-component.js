/**
 * Advanced Form Integration - "mailerlite2" action component.
 * Auto-extracted from assets/js/script.js. Loaded on demand by
 * adfoinComponentLoader.loadPlatform("mailerlite2").
 */
...
Vue.component('mailerlite2', {
    ...
    methods: {
        getCredentials: function () {
            var that = this;
            adfoinHelpers.fetchCredentials(this, 'adfoin_get_mailerlite2_credentials', {
        ...
        getLists: function () {
            adfoinHelpers.fetchToFielddata(this, 'adfoin_get_mailerlite2_list', {
                targetKey: 'list',
