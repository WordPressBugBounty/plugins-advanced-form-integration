Vue.component('tithely', {
    props: ["trigger", "action", "fielddata"],
    data: function () { return { fieldsLoading: false, fields: [] }; },
    methods: {
        getFields: function () {
            adfoinHelpers.getFields(this, 'adfoin_get_tithely_fields', { task: 'create_person', includeCredId: true, clearBefore: true });
        }
    },
    mounted: function () {
    ...
    template: '#tithely-action-template'
});
