/**
 * Advanced Form Integration — "ewebinar" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("ewebinar").
 */

Vue.component('ewebinar', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_ewebinar_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_ewebinar_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#ewebinar-action-template'
});
