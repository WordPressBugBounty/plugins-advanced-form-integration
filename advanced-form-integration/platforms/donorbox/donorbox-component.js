/**
 * Advanced Form Integration — "donorbox" action component.
 * Loaded on demand by adfoinComponentLoader.loadPlatform("donorbox").
 */

Vue.component('donorbox', {
    ...
    methods: {
        fetchCredentialsList: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_donorbox_credentials',
                _nonce: adfoin.nonce
            }, function (response) {
        ...
        fetchFields: function () {
            ...
            jQuery.post(ajaxurl, {
                action: 'adfoin_get_donorbox_fields',
                _nonce: adfoin.nonce
            }, function (response) {
    ...
    template: '#donorbox-action-template'
});
