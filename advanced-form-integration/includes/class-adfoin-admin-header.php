            ...
            switch ($this->screen_id) {
                case 'toplevel_page_advanced-form-integration':
                    if ( $this->id ) {
                        ...
                        echo 'Integrations <a href="' . esc_url(admin_url('admin.php?page=advanced-form-integration-new')) . '" class="afi-add-new">' . esc_html__('Add New', 'advanced-form-integration') . '</a>';
                    }
                    break;
