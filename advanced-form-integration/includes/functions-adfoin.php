...
function adfoin_get_form_providers() {
    $providers = array(
        ...
        'anspress'          => __( 'AnsPress', 'advanced-form-integration' ),
        'arforms'           => __( 'ARForms', 'advanced-form-integration' ),
        'armember'          => __( 'ARMember', 'advanced-form-integration' ),
        'asgarosforum'      => __( 'Asgaros Forum', 'advanced-form-integration' ),
        'avadaforms'        => __( 'Avada Forms', 'advanced-form-integration' ),
        'awesomesupport'    => __( 'Awesome Support', 'advanced-form-integration' ),
        'bbpress'           => __( 'bbPress', 'advanced-form-integration' ),
        ...
        'charitable'        => __( 'Charitable', 'advanced-form-integration' ),
        'convertpro'        => __( 'ConvertPro Forms', 'advanced-form-integration' ),
        'digimember'        => __( 'DigiMember', 'advanced-form-integration' ),
        'diviform'          => __( 'Divi Form', 'advanced-form-integration' ),
        'easyaffiliate'     => __( 'Easy Affiliate', 'advanced-form-integration' ),
        'edd'               => __( 'Easy Digital Downloads', 'advanced-form-integration' ),
        ...
        'groundhogg'        => __( 'Groundhogg', 'advanced-form-integration' ),
        'happyforms'        => __( 'Happy Forms', 'advanced-form-integration' ),
        'jetformbuilder'    => __( 'JetFormBuilder', 'advanced-form-integration' ),
        'jetpackcrm'        => __( 'Jetpack CRM', 'advanced-form-integration' ),
        'kadence'           => __( 'Kadence Blocks Form', 'advanced-form-integration' ),
        'latepoint'         => __( 'LatePoint', 'advanced-form-integration' ),
        'learndash'         => __( 'LearnDash', 'advanced-form-integration' ),
        'learnpress'        => __( 'LearnPress', 'advanced-form-integration' ),
        'lifterlms'         => __( 'LifterLMS', 'advanced-form-integration' ),
        'liveforms'         => __( 'Live Forms', 'advanced-form-integration' ),
        'mailpoet'          => __( 'MailPoet', 'advanced-form-integration' ),
        'masterstudy'       => __( 'MasterStudy LMS', 'advanced-form-integration' ),
        'memberpress'       => __( 'MemberPress', 'advanced-form-integration' ),
        'metform'           => __( 'Metform', 'advanced-form-integration' ),
        'mycred'            => __( 'myCred', 'advanced-form-integration' ),
        'newsletter'        => __( 'Newsletter', 'advanced-form-integration' ),
        'ninjaforms'        => __( 'Ninja Forms', 'advanced-form-integration' ),
        'paidmembershippro' => __( 'Paid Memberships Pro', 'advanced-form-integration' ),
        'peepso'            => __( 'PeepSo', 'advanced-form-integration' ),
        'qsm'               => __( 'Quiz and Survey Master', 'advanced-form-integration' ),
        'quform'            => __( 'Quform', 'advanced-form-integration' ),
        'rafflepress'       => __( 'RafflePress', 'advanced-form-integration' ),
        'restriccontentpro' => __( 'Restrict Content Pro', 'advanced-form-integration' ),
        'senseilms'         => __( 'Sensei LMS', 'advanced-form-integration' ),
        'slicewp'           => __( 'SliceWP', 'advanced-form-integration' ),
        'smartforms'        => __( 'Smart Forms', 'advanced-form-integration' ),
        'surecart'          => __( 'SureCart', 'advanced-form-integration' ),
        'suremembers'       => __( 'SureMembers', 'advanced-form-integration' ),
        'theeventscalendar' => __( 'The Events Calendar', 'advanced-form-integration' ),
        'thriveapprentice'  => __( 'Thrive Apprentice', 'advanced-form-integration' ),
        'thriveleads'       => __( 'Thrive Leads', 'advanced-form-integration' ),
