...
function adfoin_bitform_trigger_fields() {
    ?>
    <div class="afi-upgrade-notice" v-if="trigger.formProviderId == 'bitform' && trigger.formId">
        <span class="dashicons dashicons-info-outline" aria-hidden="true"></span>
        <p><?php esc_html_e( 'The basic AFI plugin supports text and email fields only.', 'advanced-form-integration' ); ?></p>
    </div>
    <?php
}
