...
$last_log = $wpdb->get_row( "SELECT * FROM " . $log_table . " WHERE integration_id = " . $id . " ORDER BY id DESC LIMIT 1", ARRAY_A );
    ...
    <div id="adfoin-new-integration" v-cloak>
        ...
        <div id="post-body" class="metabox-holder ">
            ...
            <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" id="edit-integration" >
                ...
                <div>
                    <p>
                        <input class="button-primary" type="submit" name="update_integration" value="<?php esc_attr_e( 'Update Integration', 'advanced-form-integration' ); ?>" />
